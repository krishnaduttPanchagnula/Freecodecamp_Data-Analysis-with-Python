...
def calculate_demographic_data(print_data=True):
    ...
    percentage_bachelors = (df['education'][df['education'] == 'Bachelors'] .count ()/df.shape[0])*100
    ...
    min_work_hours = df[df['hours-per-week'] == min(df['hours-per-week'])]

    # What percentage of the people who work the minimum number of hours per week have a salary of >50K?
    num_min_workers = (len(min_work_hours[min_work_hours['salary'] == '>50K']))


    rich_percentage = (num_min_workers/ len(min_work_hours)) * 100
